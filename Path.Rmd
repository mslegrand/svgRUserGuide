...
The **Cubic Bézier** is similar to the Quadratic Bézier, but has a higher degree allowing for a S-shaped curve. The Quadratic Bézier requires four points, $P_0$ the start point, $P_1$ the end point and 
