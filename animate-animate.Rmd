...
While set changes an attribute value instaneously, animate changes the attribute by moving from the start value to the end value in continous fashion. This makes Animate an essential work horse for animations in SVG.
...
This time we use the combo attribute *xyz* when specifying the positino.
